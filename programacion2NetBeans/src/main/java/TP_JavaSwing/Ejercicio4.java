    ...
    extends javax.swing.JFrame
{
    ...
    private char[] clave;
    private char[] contrasena = "Bienvenido".toCharArray();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.clave = this.jPasswordField1.getPassword();
        
        if(Arrays.equals(clave, contrasena)){
            System.out.println("El acceso es correcto");
        }
        else{
            System.out.println("El acceso es incorrecto");
        }
